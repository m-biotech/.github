...
*   **Cloud & Infrastructure Architecture:** Implementation of production-ready environments using **Docker, Nextflow, and GitHub Actions** on **GCP (Google Cloud Platform)** and **AWS**.
*   **Data Analysis & Visualization:** Transformation of complex results into "ready-to-use" figures and tables for scientific papers.
*   **NGS Optimization:** Consultancy on setting up optimal parameters for sequencing runs to ensure high-quality output.
